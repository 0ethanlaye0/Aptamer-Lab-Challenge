...
os.makedirs(r'C:\Users\0etha\research_tests\af3_inputs', exist_ok=True)
...
for idx, row in df.iterrows():
    ...
    filename = f"{serial}_{idx}_{complex_name}.json"

    input_json = {
        "name": complex_name,
        "sequences": [aptamer_chain, protein_chain],
        "modelSeeds": [42],
        "dialect": "alphafold3",
        "version": 1
    }

    output_path = os.path.join(r'C:\Users\0etha\research_tests\af3_inputs', filename)
